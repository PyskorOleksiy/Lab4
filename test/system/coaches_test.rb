...
class CoachesTest < ApplicationSystemTestCase
  ...
  test "creating a Coach" do
    ...
    fill_in "Appointed", with: @coach.appointed
    fill_in "Avrg coach term", with: @coach.avrg_coach_term
    fill_in "Contract until", with: @coach.contract_until
    fill_in "Name", with: @coach.name
    fill_in "Preferred formation", with: @coach.preferred_formation
